...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-azure-traffic-manager.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-azure-front-door.png)
...
kubectl get svc
```
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-afd-verify-eastus2-app-kubectl.png)

![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-afd-verify-eastus2-app-browser.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-afd-verify-westus2-app-browser.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-svc-identify-nsg.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-svc-default-nsg-config.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-svc-afd-nsg-config.png)

You should now see the updated configuration of the NSG in the inbound security rules.

![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-svc-afd-nsg-config-complete.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/afd-aks-azfirewall-arch.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-afd-verify-eastus2-app-internal-kubectl.png)
...
![alt text](https://github.com/phillipgibson/Cloud-Azure-AKS-Using-AFD-with-AKS/blob/master/images/aks-afd-verify-westus2-app-internal-kubectl.png)
